...
class App extends React.Component {
  ...
  initialize(productId = '22122') {
    Promise.all([fetch(`http://ec2-3-15-214-170.us-east-2.compute.amazonaws.com:8080/products/${productId}`), fetch(`http://ec2-3-15-214-170.us-east-2.compute.amazonaws.com:8080/products/${productId}/styles`), fetch(`http://ec2-3-15-214-170.us-east-2.compute.amazonaws.com:8080/reviews/meta?product_id=${productId}`)])
      .then((responses) => {

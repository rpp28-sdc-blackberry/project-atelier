...
class RatingsReviews extends React.Component {
  ...
  render() {
    return (
      <div className='review-overall-container' id='review-overall-container'>
        <span>RATINGS & REVIEWS</span>
        <div className='review-content-container'>
          <div id='review-left-container' className='review-sub-container left'>
            <RatingBreakdown
          ...
          <div id='review-right-container' className='review-sub-container right'>
            <SearchBar
